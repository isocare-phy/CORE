...
{
    public partial class w_acc_report_design_08 : PageWebSheet, WebSheet 
    {
        //================================
        ...
        {
            Dw_main.Retrieve("08", state.SsCoopControl);
        ...
        protected void Showformula_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                Panel2.Visible = true;
                Dw_show.Retrieve("08", state.SsCoopControl);
                //B_add.Visible = true;
        ...
        protected void B_sortseq_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int li_index = 1; li_index <= li_row; li_index++)
                {
                    ...
                    Dw_show.SetItemString(li_index, "moneysheet_code", "08");
                }
                Dw_show.UpdateData();
