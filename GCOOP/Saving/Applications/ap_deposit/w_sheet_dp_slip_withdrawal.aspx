<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_dp_slip_withdrawal.aspx.cs"
    Inherits="Saving.Applications.ap_deposit.w_sheet_dp_slip_withdrawal" Title="Untitled Page"
    ...
    <script type="text/javascript">
        ...
        function SheetLoadComplete() {
            ...
            if (Gcoop.GetEl("HdNewAccountNo").value == "true") {
                ...
                if (chec) {
                    //  TryOpenDlgDeptWith();   bee default WCA
                }
            }
        ...
        function TryOpenDlgDeptWith() {
            try {
                ...
                Gcoop.OpenIFrame(600, 650, "w_dlg_deptwith_chk.aspx", "?itemDeptWith=" + idw + "&accname=" + acc_name);
                return;
            } catch (Err) {
                alert(Err);
            }
