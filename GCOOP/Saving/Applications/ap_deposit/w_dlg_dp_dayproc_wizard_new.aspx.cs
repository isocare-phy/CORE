...
namespace Saving.Applications.ap_deposit
{
    public partial class w_dlg_dp_dayproc_wizard_new : PageWebSheet, WebSheet
    {
        ...
        {
            string sql = @"update dpdeptmaster a set a.laststmseq_no =  (select max(seq_no) from dpdeptstatement where deptaccount_no = a.deptaccount_no)
                           where  laststmseq_no <> (select max(seq_no) from dpdeptstatement where deptaccount_no = a.deptaccount_no)";
