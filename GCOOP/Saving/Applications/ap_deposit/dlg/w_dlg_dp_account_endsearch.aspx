<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_dp_account_endsearch.aspx.cs"
    Inherits="Saving.Applications.ap_deposit.dlg.w_dlg_dp_account_endsearch" ValidateRequest="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnDetailClick(s, row, n) {
            ...
            window.opener.NewAccountNo2(coopid, dept_no);
            window.close();
        }
    </script>
</head>
