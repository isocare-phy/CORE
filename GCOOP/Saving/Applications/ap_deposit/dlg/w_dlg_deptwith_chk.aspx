<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_deptwith_chk.aspx.cs"
    Inherits="Saving.Applications.ap_deposit.dlg.w_dlg_deptwith_chk" %>
    ...
    <script type="text/javascript">
        ...
        function Selected(reptCode) {
            try {
                ...
                var deptWithCode = Gcoop.GetEl("HdDeptgroup").value; 
...
<body>
    ...
    <div>
        ...
        &nbsp; &nbsp;<asp:DropDownList ID="DdDeptWith" runat="server" Width="200px" AutoPostBack="True"
            Font-Size="16px" Font-Bold="True" ForeColor="Blue" OnSelectedIndexChanged="DdDeptWith_SelectedIndexChanged" Visible="false">
