<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_dp_slip_aftercloseday.aspx.cs"
    Inherits="Saving.Applications.ap_deposit.w_sheet_dp_slip_aftercloseday" Title="Untitled Page"
    ...
    <script type="text/javascript">
        ...
        function OnButtonClicked(s, row, oName) {
            if (oName == "b_account") {
                ...
                var recpPayType = objDwMain.GetItem(row, "cash_type");
                if (recpPayType == "TRN") {
                ...
                if (coopid == "027001" || coopid == "038001" || coopid == "038002") {
                    ...
                    dpdept_no = objDwMain.GetItem(1, "deptaccount_no");
                    Gcoop.OpenIFrame2Extend("600", "600", "w_dlg_dp_signature.aspx", "?dpdept_no=" + dpdept_no);
                }
                else {
        ...
        function SheetLoadComplete() {
            ...
            if (printFlag == "true") {
                ...
                if (argPrintBook != "") {
                    //PRINTBOOK-DOYS
                    if (Gcoop.GetEl("HfCoopid").value == "038001" || Gcoop.GetEl("HfCoopid").value == "038002"||Gcoop.GetEl("HfCoopid").value == "040001") {
                        Gcoop.OpenIFrame(900, 600, "w_dlg_dp_printbook_chkprintpay.aspx", "?deptAccountNo=" + argPrintBook + "&from_dp_slip=" + argPrintSlip);
                    }else{
