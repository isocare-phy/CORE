...
{
    public partial class w_sheet_dp_slip_withdrawal : PageWebSheet, WebSheet
    {
        ...
        private void JsNewClear()
        {
            ...
            string cashType = "";
            DwMain.SetItemString(1, "group_itemtpe", ndept.of_getrevpaygrp(state.SsWsPass, "WCA"));
            DwMain.Modify("recppaytype_desc_t.text='WCA  ถอนเงินสด'");
            DwMain.SetItemString(1, "recppaytype_code", "WCA");
            DwMain.SetItemString(1, "deptwith_flag", "-");
            try
            {

                cashType = ndept.of_get_cashtype(state.SsWsPass, "WCA");
