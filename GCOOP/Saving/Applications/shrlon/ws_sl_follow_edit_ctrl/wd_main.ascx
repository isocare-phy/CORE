<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wd_main.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_follow_edit_ctrl.wd_main" %>
        ...
        <table class="DataSourceFormView" >
            <tr>
                <td colspan="6" style="text-align:right">
                    <asp:Button ID="b_process" runat="server" Text="ประมวลตั้งข้อมูลติดตามหนี้" Style="width: 150px;" />
                </td>
            </tr>
            <tr>
                <td width="10%">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="member_status" runat="server" Enabled="false">
