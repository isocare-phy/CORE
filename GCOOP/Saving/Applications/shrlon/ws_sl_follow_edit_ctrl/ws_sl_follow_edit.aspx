<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="ws_sl_follow_edit.aspx.cs" Inherits="Saving.Applications.shrlon.ws_sl_follow_edit_ctrl.ws_sl_follow_edit" %>

<%@ Register Src="wd_main.ascx" TagName="wd_main" TagPrefix="uc1" %>
<%@ Register Src="wd_detail.ascx" TagName="wd_detail" TagPrefix="uc2" %>
<%@ Register Src="wd_statement.ascx" TagName="wd_statement" TagPrefix="uc3" %>
        ...
        <tr>
            <td valign="top">
                <div id="tabs">
                    ...
                    <div id="tabs-1">
                        <uc2:wd_detail ID="wd_detail" runat="server" />
                    </div>
                    <div id="tabs-2">
                        <div align="right">
                            <span class="NewRowLink" onclick="PostInsertRow()">เพิ่มแถว</span>
                        </div>
                        <uc3:wd_statement ID="wd_statement" runat="server" />
                    </div>
                </div>
            </td>
        </tr>
