<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_slip_pay_class_ctrl.DsMain" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView" style="width: 770px;">
            ...
            <tr>
                <td colspan="8">
                    <div align="right" style="display: none">
                        <asp:CheckBox ID="print" runat="server" />บันทึก&พิมพ์ใบเสร็จ
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:TextBox ID="entry_id" runat="server" Style="width: 198px; text-align: center"></asp:TextBox>
                </td>
            </tr>
            <tr style="display:none">
                ...
                <td colspan="2">
                    <asp:TextBox ID="cp_refslip" runat="server" Style="text-align: center"></asp:TextBox>
                </td>
                <td>
                    <div>
                        <span>จำนวน:</span>
                ...
                <td colspan="2">
                    <asp:TextBox ID="ref_slipamt" runat="server" Style="text-align: right;" ToolTip="#,##0.00"
                        onBlur="checkValue(this,this.defaultValue)" onFocus="clearValue(this,this.defaultValue)"></asp:TextBox>
                </td>
                <td>
                    <asp:Button ID="b_ref" runat="server" Text="..." Style="margin-right: 2px; font-size: 16px;
                        width: 20px;" Font-Bold="true " />
                </td>
                <td>
                </td>
            </tr>
