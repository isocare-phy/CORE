<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsDetailLoan.ascx.cs"
    Inherits="Saving.Applications.shrlon.ws_sl_slip_pay_class_ctrl.DsDetailLoan" %>
            ...
            <tr>
                ...
                <td width="8%">
                    <asp:TextBox ID="cp_interestpay" runat="server" Style="text-align: right; font-size: 11px;
                        background-color: #EEEEEE;" ToolTip="#,##0.00" onBlur="checkValue(this,this.defaultValue)"
