<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_reprint_payout_ctrl.DsMain" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="document_no_s" runat="server" Width="90px"></asp:TextBox>
                </td>
                <td>
                    -
                </td>
                <td>
                    <asp:TextBox ID="document_no_e" runat="server" Width="90px"></asp:TextBox>
                </td>
