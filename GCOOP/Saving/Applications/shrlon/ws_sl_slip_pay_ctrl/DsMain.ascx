<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.shrlon.ws_sl_slip_pay_ctrl.DsMain" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView" style="width: 770px;">
            ...
            <tr >
                ...
                <td colspan="2">
                    <asp:TextBox ID="cp_refslip" runat="server"></asp:TextBox>
                </td>
                <td>
                    <div>
                        <span>จำนวน:</span>
                ...
                <td colspan="2">
                    <asp:TextBox ID="ref_slipamt" runat="server" Style="text-align: right; width: 170px;" ToolTip="#,##0.00" onBlur="checkValue(this,this.defaultValue)" onFocus="clearValue(this,this.defaultValue)" ></asp:TextBox>
