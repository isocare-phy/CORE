            ...
            <tr>
                ...
                <td width="8%">
                    <asp:TextBox ID="cp_interestpay" runat="server" Style="text-align: right; font-size: 11px;
                        background-color: #EEEEEE;" ToolTip="#,##0.00" onBlur="checkValue(this,this.defaultValue)" onFocus="clearValue(this,this.defaultValue)"></asp:TextBox>
                </td>
                <td width="10%">
                    <asp:TextBox ID="principal_payamt" runat="server" Style="text-align: right; font-size: 11px;
                        background-color: #CCFF66;" ToolTip="#,##0.00" onBlur="checkValue(this,this.defaultValue)" onFocus="clearValue(this,this.defaultValue)"></asp:TextBox>
                </td>
                <td width="8%">
