<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_show_accid.aspx.cs" Inherits="Saving.Applications.shrlon.dlg.w_dlg_show_accid" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function selectRow(sender, rowNumber, objectName) {
            ...
            var deptaccount_name = objdw_detail.GetItem(rowNumber, "bank_accid");
            var prncbal = Gcoop.ParseFloat(objdw_detail.GetItem(rowNumber, "prncbal"));
          //  alert(prncbal);
            window.opener.GetValueAccID(dept_no, deptaccount_name, 0);
            window.close();
...
<body>
    ...
    <table >
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_detail" runat="server" DataWindowObject="d_sl_mb_moneytr_list"
                LibraryList="~/DataWindow/Shrlon/sl_loan_requestment.pbl" Width="600px" Style="top: 0px;
