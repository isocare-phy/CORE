<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.shrlon.w_sheet_sl_loan_receive_list_ctrl.DsMain1" %>
        ...
        <table class="DataSourceFormView">
            ...
            <tr>
                ...
                <td width="20%">
                        ...
                        <asp:Button ID="b_show" runat="server" Text="ดึงข้อมูล" Style="font-size: 15px; width: 50%;"
                            Font-Bold="true" BackColor="#FFCCCC" />
                    
                    
                       <asp:Button ID="b_loop_save" runat="server" Text="จ่ายทันที" Style="margin-right: 2px;
                            font-size: 16px; width: 5%;" Font-Bold="true " /> 
