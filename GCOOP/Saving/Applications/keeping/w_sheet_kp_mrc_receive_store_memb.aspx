<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_kp_mrc_receive_store_memb.aspx.cs"
    Inherits="Saving.Applications.keeping.w_sheet_kp_mrc_receive_store_memb" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <table style="width: 100%;">
        <tr>
            <td colspan="3">
                <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_kp_option_proc_memb"
