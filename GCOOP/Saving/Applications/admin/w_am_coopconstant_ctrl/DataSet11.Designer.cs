...
namespace Saving.Applications.admin.w_am_coopconstant_ctrl.DataSet1TableAdapters {
    ...
    public partial class CMCOOPCONSTANTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO ""CMCOOPCONSTANT"" (""COOP_NO"", ""COOP_NAME"", ""COOP_ADDR"", ""TAMBOL"", ""POSTCODE"", ""COOP_TEL"", ""COOP_FAX"", ""OFFICE_FINANCE"", ""AUDITOR_ADDR"", ""RETRY_MONTH"", ""OFFICE_ACCOUNT"", ""AUDITOR"", ""RETRY_AGE"", ""DISTRICT_DESC"", ""PROVINCE_DESC"", ""MANAGER"", ""COOP_ROAD"") VALUES (:COOP_NO, :COOP_NAME, :COOP_ADDR, :TAMBOL, :POSTCODE, :COOP_TEL, :COOP_FAX, :OFFICE_FINANCE, :AUDITOR_ADDR, :RETRY_MONTH, :OFFICE_ACCOUNT, :AUDITOR, :RETRY_AGE, :DISTRICT_DESC, :PROVINCE_DESC, :MANAGER, :COOP_ROAD)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""CMCOOPCONSTANT"" SET ""COOP_NO"" = :COOP_NO, ""COOP_NAME"" = :COOP_NAME, ""COOP_ADDR"" = :COOP_ADDR, ""TAMBOL"" = :TAMBOL, ""POSTCODE"" = :POSTCODE, ""COOP_TEL"" = :COOP_TEL, ""COOP_FAX"" = :COOP_FAX, ""OFFICE_FINANCE"" = :OFFICE_FINANCE, ""AUDITOR_ADDR"" = :AUDITOR_ADDR, ""RETRY_MONTH"" = :RETRY_MONTH, ""OFFICE_ACCOUNT"" = :OFFICE_ACCOUNT, ""AUDITOR"" = :AUDITOR, ""RETRY_AGE"" = :RETRY_AGE, ""DISTRICT_DESC"" = :DISTRICT_DESC, ""PROVINCE_DESC"" = :PROVINCE_DESC, ""MANAGER"" = :MANAGER, ""COOP_ROAD"" = :COOP_ROAD WHERE ((""COOP_NO"" = :Original_COOP_NO))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        COOP_NO, COOP_NAME, COOP_ADDR, TAMBOL, POSTCODE, COOP_TEL, COOP_FAX, OFFICE_FINANCE, AUDITOR_ADDR, RETRY_MONTH, OFFICE_ACCOUNT, AUDITOR, RETRY_AGE, DISTRICT_DESC, 
                         PROVINCE_DESC, MANAGER, COOP_ROAD
FROM            CMCOOPCONSTANT";
        ...
        public virtual int Insert(
            ...
            if ((COOP_ROAD == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[16].Value = ((string)(COOP_ROAD));
            }
        ...
        public virtual int Update(
            ...
            if ((COOP_ROAD == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((string)(COOP_ROAD));
            }
            if ((Original_COOP_NO == null)) {
                throw new global::System.ArgumentNullException("Original_COOP_NO");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[17].Value = ((string)(Original_COOP_NO));
            }
        ...
        public virtual int Update(
                    ...
                    string COOP_ROAD, 
                    string Original_COOP_NO) {
            return this.Update(Original_COOP_NO, COOP_NAME, COOP_ADDR, TAMBOL, POSTCODE, COOP_TEL, COOP_FAX, OFFICE_FINANCE, AUDITOR_ADDR, RETRY_MONTH, OFFICE_ACCOUNT, AUDITOR, RETRY_AGE, DISTRICT_DESC, PROVINCE_DESC, MANAGER, COOP_ROAD, Original_COOP_NO);
        }
    }
