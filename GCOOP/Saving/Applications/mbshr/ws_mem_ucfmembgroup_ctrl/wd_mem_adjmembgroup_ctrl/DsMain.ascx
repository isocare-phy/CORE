<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.mbshr.ws_mem_ucfmembgroup_ctrl.wd_mem_adjmembgroup_ctrl.DsMain" %>
        ...
        <table class="DataSourceFormView" border="0" style="width: 600px;">
            ...
            <tr>
               ...
               <%-- <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="MEMBGROUP_LEVEL" runat="server">
                                    <asp:ListItem Value=1>1  group control</asp:ListItem>
                                    <asp:ListItem Value=2>2  บริษัทหรือสังกัด</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>--%>
            </tr>
