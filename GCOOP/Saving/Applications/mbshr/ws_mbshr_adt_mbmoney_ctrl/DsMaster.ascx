<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMaster.ascx.cs" Inherits="Saving.Applications.mbshr.ws_mbshr_adt_mbmoney_ctrl.DsMaster" %>
    ...
    <EditItemTemplate>               
        <table class="DataSourceFormView" style="width:240px;">  
                        ...
                        <tr>                
                            ...
                            <td>
                                <asp:DropDownList ID="expense_code" runat="server" Style="width:140px;font-size: 12px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="expense_accid" runat="server" Style="width:140px;font-size: 12px; text-align: center;"></asp:TextBox>
                            </td>
                        </tr>
                    </table>    
    </EditItemTemplate>
