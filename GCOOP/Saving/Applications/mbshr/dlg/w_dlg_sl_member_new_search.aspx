<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_member_new_search.aspx.cs"
    Inherits="Saving.Applications.mbshr.dlg.w_dlg_sl_member_new_search" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function ItemChangeDwData(sender, rowNumber, columnName, newValue) {
            ...
            if (columnName == "group_no") {
                //alert(newValue);
                var group_no = newValue;
                //var docNo = Gcoop.StringFormat(docNo, "0000000000");

                objdw_data.SetItem(1, "group_no_1", group_no);
                //Gcoop.GetEl("group_no").value = group_no;
                objdw_data.AcceptText();
                // LoanContractSearch();
            }
        }
