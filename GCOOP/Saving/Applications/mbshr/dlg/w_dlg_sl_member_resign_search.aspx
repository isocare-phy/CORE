<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_sl_member_resign_search.aspx.cs"
    Inherits="Saving.Applications.mbshr.dlg.w_dlg_sl_member_resign_search" %>
...
<body>
        ...
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_data" runat="server" 
                    DataWindowObject="d_sl_member_resign_search"
                    LibraryList="~/DataWindow/mbshr/sl_member_resign.pbl" 
    ...
    <dw:WebDataWindowControl ID="dw_detail" runat="server" ClientEventClicked="selectRow"
        DataWindowObject="d_sl_member_resign_list" LibraryList="~/DataWindow/mbshr/sl_member_resign.pbl"
