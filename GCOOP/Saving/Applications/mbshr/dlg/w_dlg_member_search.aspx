<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="w_dlg_member_search.aspx.cs" Inherits="Saving.Applications.mbshr.dlg.w_dlg_member_search" %>
...
<body>
        ...
        <tr>
            <td>
                <dw:WebDataWindowControl ID="dw_data" runat="server" ClientScriptable="True" DataWindowObject="d_sl_membsrch_criteria"
                    LibraryList="~/DataWindow/mbshr/sl_member_search.pbl">
    ...
    <dw:WebDataWindowControl ID="dw_detail" runat="server" ClientEventClicked="selectRow"
        DataWindowObject="d_sl_membsrch_list_memno2" LibraryList="~/DataWindow/mbshr/sl_member_search.pbl"
