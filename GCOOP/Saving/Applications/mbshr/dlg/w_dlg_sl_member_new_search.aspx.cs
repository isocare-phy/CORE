...
{
    public partial class w_dlg_sl_member_new_search : PageWebDialog, WebDialog
    {
        ...
        protected void cb_find_Click(object sender, EventArgs e)
        {
            ...
            String mem_tdate = "";
            String work_tdate = "";
            String membgroup_code = "";// dw_data.GetItemString(1, "group_no").Trim();
            ...
            try
            {
                membgroup_code = dw_data.GetItemString(1, "group_no").Trim();
            ...
            {
                ls_sqlext = " and (  mbreqappl.membgroup_code like '%" + membgroup_code + "%') ";
            }
