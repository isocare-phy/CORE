...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function MenubarOpen() {
            Gcoop.OpenDlg('805', '370', 'w_dlg_finconfrim.aspx');
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <input type="button" value="พิมพ์ใบเสร็จสินเชื่อ" style="width: 110px" onclick="OnPostPrintShr()" />
    ...
    <asp:HiddenField ID="HdShrslipNo" runat="server" />
</asp:Content>
