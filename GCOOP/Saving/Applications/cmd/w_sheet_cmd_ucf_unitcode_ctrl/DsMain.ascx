<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.cmd.w_sheet_cmd_ucf_unitcode_ctrl.DsMain" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView"  style="width:500px;">
            <tr>
                 <td width="10%">
                    <div>
                        <span>ชื่อหน่วยวัสดุ :</span>
                    </div>
                </td>
                <td width="25%">
                     <div>
                        <asp:TextBox ID="unit_desc" runat="server" Style="text-align: left" ></asp:TextBox>
                    </div>
                </td>             
            </tr>
        </table>
