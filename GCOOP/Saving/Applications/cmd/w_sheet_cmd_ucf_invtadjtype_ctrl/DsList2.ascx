<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsList2.ascx.cs" Inherits="Saving.Applications.cmd.w_sheet_cmd_ucf_invtadjtype_ctrl.DsList2" %>
...
<asp:Panel ID="Panel" runat="server" 
    ...
    <tr>
        <td style="text-align:left;">
                        <span style="color:Red;font-size:15px;"><u><b>ฝั่งรายการออก</u></b> </span>
                  </td>
                  </tr>
