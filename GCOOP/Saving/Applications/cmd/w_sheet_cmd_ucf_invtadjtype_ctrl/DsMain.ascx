<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.cmd.w_sheet_cmd_ucf_invtadjtype_ctrl.DsMain" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView" style="width:500px;">
            <tr>
                 <td width="15%">
                    <div>
                        <span>รายละเอียดการปรับปรุง :</span>
                    </div>
                </td>
                <td width="25%">
                     <div>
