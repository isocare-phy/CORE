<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsUcfasstypedet.ascx.cs" Inherits="Saving.Applications.assist.ws_sheet_as_ucfassist_ctrl.DsUcfasstypedet" %>
