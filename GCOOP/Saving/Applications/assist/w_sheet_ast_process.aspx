<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_ast_process.aspx.cs"
    Inherits="Saving.Applications.assist.w_sheet_ast_process" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <table style="width: 100%;">
        <tr>
            <td colspan="3">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" DataWindowObject="d_ast_22_process_cri"
