<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="ws_wheet_as_ucfassisttype.aspx.cs" Inherits="Saving.Applications.assist.ws_wheet_as_ucfassisttype_ctrl.ws_wheet_as_ucfassisttype" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">  
    <script type="text/javascript">
        ...
        function OnDsListItemChanged(s, r, c, v) {
            if (c == "stm_flag") {
                if (v == "1") {
                    dsList.GetElement(r, "process_flag").disabled = false;
                } else {
                    dsList.GetElement(r, "process_flag").disabled = true;
                }
            }
        }
