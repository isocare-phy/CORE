<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsLoan.ascx.cs" Inherits="Saving.Applications.assist.dlg.ws_dlg_as_assistpay_v2_ctrl.DsLoan" %>
...
<table class="DataSourceRepeater">
    ...
    <asp:Repeater ID="Repeater1" runat="server">
        <ItemTemplate>    
            <tr>
                <td>
                    <asp:DropDownList ID="payback_type" runat="server" >
                        <asp:ListItem Value="LON">LON</asp:ListItem>
                        <asp:ListItem Value="ETC">ETC</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td>
                    <asp:TextBox ID="loan_detail" runat="server"></asp:TextBox>
                </td>
                <td>
