...
{
    public partial class u_cri_coopid_year_rgrp_rmemno_name_position_date_ex : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "start_objective_1", "criteria.pbl", state.SsCoopControl);
            DwUtil.RetrieveDDDW(dw_criteria, "end_objective_1", "criteria.pbl", state.SsCoopControl);
            ...
            else
            {
                ...
                JsGetYear();
                string[] minmax_obj = ReportUtil.GetMinMaxMembloanobjective();
                dw_criteria.SetItemString(1, "start_objective", minmax_obj[0].Trim());
                dw_criteria.SetItemString(1, "end_objective", minmax_obj[1].Trim());
                string[] minmax = ReportUtil.GetMinMaxMembgroup();
                dw_criteria.SetItemString(1, "start_membgroup", minmax[0].Trim());
                dw_criteria.SetItemString(1, "end_membgroup", minmax[1].Trim());
        ...
        private void RunProcess()
        {
            ...
            String ai_year = dw_criteria.GetItemString(1, "ai_year");
            String start_objective = dw_criteria.GetItemString(1, "start_objective_1");
            string end_objective = dw_criteria.GetItemString(1, "end_objective_1");
            ...
            {
                start_membgroup = minmax[0].Trim();
            }
            if (end_membgroup == "" || end_membgroup == null)
            {
                end_membgroup = minmax[1].Trim();
            }
            ...
            human_name = dw_criteria.GetItemString(1, "human_name");
            human_position = dw_criteria.GetItemString(1, "human_position");
           ...
           /* try
            ...
            lnv_helper.AddArgument(ai_year, ArgumentType.String);
        ...
        private void JsGetYear()
        {
            ...
            try
            {
                ...
                if (dt.Next())
                {
                    ...
                    dw_criteria.SetItemString(1, "ai_year", Convert.ToString(account_year));
                }
                else
                {
                    sqlca.Rollback();
            ...
            catch (Exception ex)
            {
                ...
                dw_criteria.SetItemString(1, "ai_year", account_year.ToString());
