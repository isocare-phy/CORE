...
{
    public partial class u_cri_rmembno_rmembgroup : PageWebSheet, WebSheet
    {
        ...
        {
            //ให้หน้า page refresh
            dw_criteria.SetItemString(1, "as_startmem", HdStMem.Value);
        }
        private void CheckFlag3()
        {
            //ให้หน้า page refresh
            dw_criteria.SetItemString(1, "as_endmem", HdEnMem.Value);
        }     
        #endregion
