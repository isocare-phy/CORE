...
{
    public partial class u_cri_coop_rdate_rbank_chqno : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "as_bank", "criteria.pbl", null);
            if (IsPostBack)
            {
        ...
        private void CheckFlag()
        {
            ...
            if (fixed_flagtest == 0)
            {
                dw_criteria.SetItemString(1, "as_bank", "");
        ...
        private void RunProcess()
        {
            ...
            String as_bank = dw_criteria.GetItemString(1, "as_bank");
            String as_chqno = dw_criteria.GetItemString(1, "as_chqno");
            ...
            lnv_helper.AddArgument(as_bank, ArgumentType.String);
            lnv_helper.AddArgument(as_chqno, ArgumentType.StringArray);
            //----------------------------------------------------
