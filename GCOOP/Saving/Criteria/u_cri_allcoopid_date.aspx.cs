...
{
    public partial class u_cri_allcoopid_date : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            try
            {
                allcoopid = Convert.ToInt16(dw_criteria.GetItemDecimal(1, "allcoop_flag"));
            }
            catch { allcoopid = 0; }
            String coop_id = "%";
            try
            {
                coop_id = dw_criteria.GetItemString(1, "select_coop");
            }
            catch { coop_id = "%"; }
            ...
            // หากเลือกเป็น ทุกสาขา
            if (allcoopid == 1) { coop_id = "%"; }
