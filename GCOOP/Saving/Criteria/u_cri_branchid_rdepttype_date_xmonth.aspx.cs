...
{
    public partial class u_cri_branchid_rdepttype_date_xmonth : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDecimal(1, "xmonth", 60);
        ...
        private void RunProcess()
        {
            ...
            decimal xmonth = dw_criteria.GetItemDecimal(1, "xmonth");
            ...
            lnv_helper.AddArgument(xmonth.ToString(), ArgumentType.Number);
