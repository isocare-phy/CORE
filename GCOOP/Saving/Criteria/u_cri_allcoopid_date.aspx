<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_allcoopid_date.aspx.cs"
    Inherits="Saving.Criteria.u_cri_allcoopid_date" Title="Report Criteria" %>
...
<%=runProcess%>
		...
		<script type="text/javascript">
		    ...
		    function SelectUser(strvalue) {
		        objdw_criteria.SetItem(1, "all_coopid", strvalue);
		        objdw_criteria.AcceptText();
		    }
		</script>
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_allcoopid_date"
