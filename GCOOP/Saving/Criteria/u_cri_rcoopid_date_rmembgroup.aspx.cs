...
{
    public partial class u_cri_rcoopid_date_rmembgroup : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                DwUtil.RetrieveDDDW(dw_criteria, "select_coopid", "criteria.pbl", state.SsCoopControl);
                dw_criteria.SetItemString(1, "select_coop", state.SsCoopId);
                dw_criteria.SetItemString(1, "select_coopid", state.SsCoopId);
        ...
        private void RunProcess()
        {
            ...
            String tocoop_id = dw_criteria.GetItemString(1, "select_coopid");
            ...
            lnv_helper.AddArgument(tocoop_id, ArgumentType.String);
