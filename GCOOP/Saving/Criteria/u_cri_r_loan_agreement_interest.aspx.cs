...
{
    public partial class u_cri_r_loan_agreement_interest : PageWebSheet,WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "member_no", "");
                dw_criteria.SetItemString(1, "document", "");
                dw_criteria.SetItemString(1, "interest", "");
        ...
        private void RunProcess()
        {
            ...
            String membno = dw_criteria.GetItemString(1, "member_no");
            String document = dw_criteria.GetItemString(1, "document");
            String start_date = WebUtil.ConvertDateThaiToEng(dw_criteria, "start_tdate", null);
            String interest = dw_criteria.GetItemString(1, "interest");
            ...
            lnv_helper.AddArgument(document, ArgumentType.String);
            lnv_helper.AddArgument(start_date, ArgumentType.DateTime);
            lnv_helper.AddArgument(interest, ArgumentType.Number);
