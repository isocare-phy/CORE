...
{
    public partial class u_cri_cid_recvp_rmbgpctl_bycid_core : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            //String membtypes = dw_criteria.GetItemString(1, "membtype").Trim();
            //String membtypee = dw_criteria.GetItemString(1, "membtype").Trim();
            //if (membtypes == "01")
            //{
            //    membtypes = "01";
            //    membtypee = "01";
            //}
            //else if (membtypes == "02")
            //{
            //    membtypes = "02";
            //    membtypee = "02";
            //}
            ...
            //lnv_helper.AddArgument("01", ArgumentType.String);
            //lnv_helper.AddArgument("03", ArgumentType.String);
