...
{
    public partial class u_cri_coopid_status : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "start_loantype","0");
                //dw_criteria.SetItemString(1, "end_loantype", "1");
        ...
        private void RunProcess()
        {
            ...
            if (start_loantype == "0")
            {
                ...
                //lnv_helper.AddArgument(start_loantype, ArgumentType.String); //LEK Comment เนื่องจาก m_address_cloud = ที่อยู่ตามทะเบียน รับ Agrument 1 ค่า คือ coop_id
            }
            else if (start_loantype == "1")
            {
                rid = "MBSHR_ETC150";
                lnv_helper.AddArgument(coop_id, ArgumentType.String);
                //lnv_helper.AddArgument(start_loantype, ArgumentType.String); //LEK Comment เนื่องจาก m_address_now_cloud = ที่อยู่ปัจจุบัน รับ Agrument 1 ค่า คือ coop_id
            }
