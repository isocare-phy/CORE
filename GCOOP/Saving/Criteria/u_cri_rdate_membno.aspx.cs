...
{
    public partial class u_cri_rdate_membno : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "select_membno", "");
        ...
        private void JsMemberNo()
        {
            ...
            dw_criteria.SetItemString(1, "select_membno", mem_no);
        }
        ...
        private void RunProcess()
        {
            ...
            String select_membno = dw_criteria.GetItemString(1, "select_membno");
            ...
            lnv_helper.AddArgument(select_membno, ArgumentType.String);
