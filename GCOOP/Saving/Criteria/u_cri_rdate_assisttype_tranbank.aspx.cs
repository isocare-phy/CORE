...
{
    public partial class u_cri_rdate_assisttype_tranbank : PageWebSheet, WebSheet
    {
        ...
        public void InitJsPostBack()
        {
            ...
            tdw_criteria.Add("as_coop_control", "as_coop_control");
            tdw_criteria.Add("start_date", "start_tdate");
            tdw_criteria.Add("end_date", "end_tdate");
            tdw_criteria.Add("as_startassist", "as_startassist");
            tdw_criteria.Add("as_bankcode", "as_bankcode");
            tdw_criteria.Add("as_partion", "as_partion");
        }
        ...
        private void RunProcess()
        {
            ...
            try
            {
                bank_all = Convert.ToInt16(dw_criteria.GetItemDecimal(1, "bank_all"));
            }
            catch { bank_all = 0; }
            ...
            try
            {
                ...
                //Int16 bankall = Convert.ToInt16(dw_criteria.GetItemString(1, "bankall_status")); 
            }
            catch
            {
                bank_code = "%%";
                // กำหนดเครื่อง %% หมายถึงให้รายงานดึงข้อมูลทั้งหมด แต่ใช้ได้กับ where ในการ like
            }
