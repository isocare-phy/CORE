<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_coopid_rdate_username_choose.aspx.cs" Inherits="Saving.Criteria.u_cri_coopid_rdate_username_choose" %>
...
<%=runProcess%>
		...
		<script type="text/javascript">
		    ...
		    function OnButtonClicked(sender, rowNumber, buttonName) {
		        if (buttonName == "b_search") {
		            Gcoop.OpenIFrame('480', '500', 'w_dlg_popup_user.aspx', '');
		        }
		    }

		    function SelectUser(strvalue) {
		        objdw_criteria.SetItem(1, "select_username", strvalue);
		        objdw_criteria.AcceptText();
		    }
		</script>
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_coopid_rdate_username_choose"
