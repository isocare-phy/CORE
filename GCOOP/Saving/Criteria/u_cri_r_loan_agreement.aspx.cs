...
{
    public partial class u_cri_r_loan_agreement : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "membno", "");
                dw_criteria.SetItemString(1, "documentno", "");
        ...
        private void RunProcess()
        {
            ...
            String membno = dw_criteria.GetItemString(1, "membno");
            String document = dw_criteria.GetItemString(1, "documentno");
