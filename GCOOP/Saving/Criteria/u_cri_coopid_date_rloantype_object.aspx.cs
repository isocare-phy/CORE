...
{
    public partial class u_cri_coopid_date_rloantype_object : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String start_date = WebUtil.ConvertDateThaiToEng(dw_criteria, "start_tdate","");
            String end_date = WebUtil.ConvertDateThaiToEng(dw_criteria, "end_tdate", "");
