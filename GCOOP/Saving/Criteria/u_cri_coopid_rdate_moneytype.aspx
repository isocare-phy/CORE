<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_coopid_rdate_moneytype.aspx.cs"
    Inherits="Saving.Criteria.u_cri_coopid_rdate_moneytype" Title="Report Criteria" %>
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_rdate_moneytype"
