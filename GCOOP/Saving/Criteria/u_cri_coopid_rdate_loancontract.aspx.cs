...
{
    public partial class u_cri_coopid_rdate_loancontract : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "select_contract","");
        ...
        private void RunProcess()
        {
            ...
            String select_contract = dw_criteria.GetItemString(1, "select_contract");
            ...
            lnv_helper.AddArgument(select_contract, ArgumentType.String);
