...
{
    public partial class u_cri_coopid_divyear_rmembgroup_paytype: PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
           ...
           // DwUtil.RetrieveDDDW(dw_criteria, "ai_year", "criteria.pbl", state.SsCoopControl);  
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "smoney_type", "criteria.pbl", state.SsCoopControl);
            DwUtil.RetrieveDDDW(dw_criteria, "emoney_type", "criteria.pbl", state.SsCoopControl);  
        ...
        public void CheckJsPostBack(string eventArg)
        {
            ...
            else if (eventArg == "post")
            {
                ...
                DwUtil.RetrieveDDDW(dw_criteria, "smoney_type", "criteria.pbl", null);
                DwUtil.RetrieveDDDW(dw_criteria, "emoney_type", "criteria.pbl", null);
            }
        }
        ...
        private void RunProcess()
        {
            ...
            String smoney_type       = dw_criteria.GetItemString(1, "smoney_type").Trim();
            String emoney_type = dw_criteria.GetItemString(1, "emoney_type").Trim();
            ...
            lnv_helper.AddArgument(smoney_type, ArgumentType.String);
            lnv_helper.AddArgument(emoney_type, ArgumentType.String);
