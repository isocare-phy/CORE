...
{
    public partial class u_cri_rdate_assistype : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            DwUtil.RetrieveDDDW(dw_criteria, "start_assisttype", "criteria.pbl", state.SsCoopControl);
            DwUtil.RetrieveDDDW(dw_criteria, "member_type", "criteria.pbl", state.SsCoopControl);
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "start_assisttype", minmax[0]);
                dw_criteria.SetItemString(1, "member_type", minmax[0]);
        ...
        private void RunProcess()
        {
            ...
            String start_assisttype = dw_criteria.GetItemString(1, "start_assisttype");
            String member_type = dw_criteria.GetItemString(1, "member_type");
            ...
            lnv_helper.AddArgument(start_assisttype, ArgumentType.String);
            lnv_helper.AddArgument(member_type, ArgumentType.String);
