<%@ Page Title="Report Criteria" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_rcondition_rgroups.aspx.cs" Inherits="Saving.Criteria.u_cri_rcondition_rgroups" %>
...
<%=runProcess%>
		...
		<script type="text/javascript">
		    ...
		    function OnDwCriteriaItemsChanged(sender, rowNumber, columnName, newValue) {
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_coopid_rconditionsh_rgroup"
                    LibraryList="~/DataWindow/criteria/criteria.pbl" 
                    AutoSaveDataCacheAfterRetrieve="True" 
                    ClientEventItemChanged="OnDwCriteriaItemsChanged">
