...
{
    public partial class u_cri_coopid_rdate_begin_amt_rank : PageWebSheet, WebSheet
    {
        ...
        private void RunProcess()
        {
            ...
            String sql3 = @"select period_end_date from accperiod  where  coop_id ='" + state.SsCoopId + "' and account_year = '" + accyear + "' and period = '" + accperiod + "' ";  //** แก้ให้ออกเงินสดยกมางวด 1 ได้
            ...
            Int32 CashBeginForward = wcf.NAccount.of_get_cash_bg_fw_first_period(wsPass, period_end_date, state.SsCoopId, ref Begin, ref Forward);
            ldc_total = Forward;
