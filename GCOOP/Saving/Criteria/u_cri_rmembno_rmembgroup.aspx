<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_rmembno_rmembgroup.aspx.cs"
    Inherits="Saving.Criteria.u_cri_rmembno_rmembgroup" Title="Report Criteria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnDwCriteriaItemsChange(sender, rowNumber, columnName, newValue) {
            ...
            var value = "";
            value = Gcoop.StringFormat(newValue, "000000");
            ...
            else if (columnName == "as_startmem") {
                Gcoop.GetEl("HdStMem").value = value;
                checkFlag2();
            }
            else if (columnName == "as_endmem") {
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_cri_rmembno_rmembgroup"
