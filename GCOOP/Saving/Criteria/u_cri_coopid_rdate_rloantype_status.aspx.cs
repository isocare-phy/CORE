...
{
    public partial class u_cri_coopid_rdate_rloantype_status : PageWebSheet, WebSheet
    {
        ...
        public void CheckJsPostBack(string eventArg)
        {
            ...
            //{
            //    DwUtil.RetrieveDDDW(dw_criteria, "start_loantype_1", "criteria.pbl", null);
            //    DwUtil.RetrieveDDDW(dw_criteria, "end_loantype_1", "criteria.pbl", null);
            //}
        }
        ...
        private void RunProcess()
        {
            ...
            Int16 loan_status = Convert.ToInt16(dw_criteria.GetItemDecimal(1, "select_status"));
            ...
            lnv_helper.AddArgument(loan_status.ToString(), ArgumentType.Number);
           // lnv_helper.AddArgument(partion_group, ArgumentType.String);
