...
{
    public partial class u_cri_coopid_count_day : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemDecimal(1, "count", 30);
        ...
        private void RunProcess()
        {
            ...
            decimal count = dw_criteria.GetItemDecimal(1, "count");
            ...
            lnv_helper.AddArgument(count.ToString(), ArgumentType.Number);
