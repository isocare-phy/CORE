<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_coopid_memno_collmastno_date_province_different.aspx.cs" Inherits="Saving.Criteria.u_cri_coopid_memno_collmastno_date_province_different" %>
		...
		<script type="text/javascript">
		    ...
		    function ItemChangedMain(sender, rowNumber, columnName, newValue) {
		        if (columnName == "member_no") {
		            objdw_criteria.SetItem(rowNumber, columnName, Gcoop.StringFormat(newValue, "00000000"));
		            objdw_criteria.AcceptText();
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_sl_cri_memno_collmastno_date_province_different"
                    LibraryList="~/DataWindow/criteria/criteria.pbl" ClientEventItemChanged="ItemChangedMain"
