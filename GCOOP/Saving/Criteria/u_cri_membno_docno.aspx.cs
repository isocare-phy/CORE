...
{
    public partial class u_cri_membno_docno : PageWebSheet, WebSheet
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "doc_no", "");
            }
        ...
        private void JsMemberNo()
        {
            ...
            dw_criteria.SetItemString(1, "start_membno", mem_no);
        }
        #endregion
        ...
        private void RunProcess()
        {
            ...
            String document_no = dw_criteria.GetItemString(1, "doc_no");
            ...
            lnv_helper.AddArgument(document_no, ArgumentType.String);
