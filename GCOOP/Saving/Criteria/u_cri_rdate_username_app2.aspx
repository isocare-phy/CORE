<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_rdate_username_app2.aspx.cs" Inherits="Saving.Criteria.u_cri_rdate_username_app2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnDwAdListItemClick(s, r, c) {
            if (c != "datawindow") {
                objdw_criteria.SetItem(1, "as_user_name", objdw_ad_list.GetItem(r, "user_name"));
            }
        }
    </script>
</asp:Content>
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_cri_rdate_username_app2"
                    LibraryList="~/DataWindow/criteria/criteria.pbl" AutoSaveDataCacheAfterRetrieve="True">
                </dw:WebDataWindowControl>
           
            <br />
            <dw:WebDataWindowControl ID="dw_ad_list" runat="server" AutoRestoreContext="False"
                AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_admin_user_list"
                LibraryList="~/DataWindow/criteria/criteria.pbl" AutoSaveDataCacheAfterRetrieve="True"
                ClientEventClicked="OnDwAdListItemClick" RowsPerPage="15" PageNavigationBarSettings-Visible="True"
                PageNavigationBarSettings-NavigatorType="Numeric">
            </dw:WebDataWindowControl>
             </td>
        </tr>
        <tr>
