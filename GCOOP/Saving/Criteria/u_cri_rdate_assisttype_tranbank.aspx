<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_rdate_assisttype_tranbank.aspx.cs"
    Inherits="Saving.Criteria.u_cri_rdate_assisttype_tranbank" Title="Report Criteria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function DwCriClick(sender, rowNumber, objectName) {
            if (objectName == "bank_all") {
                Gcoop.CheckDw(sender, rowNumber, objectName, "bank_all", 1, 0);
        ...
        <tr>
            <td align="center" style="width: 500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    AutoRestoreDataCache="True" ClientFormatting="True" ClientScriptable="True" DataWindowObject="d_cri_rdate_bank"
                    LibraryList="~/DataWindow/criteria/criteria.pbl" AutoSaveDataCacheAfterRetrieve="True" ClientEventClicked="DwCriClick">
