...
{
    public partial class u_cri_coopid_rdate_username_choose : PageWebSheet, WebSheet
    {
        ...
        {
            //InitJsPostBack();
            DwUtil.RetrieveDDDW(dw_criteria, "selectcoop_id", "criteria.pbl", state.SsCoopControl);
            if (IsPostBack)
            {
            ...
            else
            {
                ...
                dw_criteria.SetItemString(1, "selectcoop_id", state.SsCoopId);
                dw_criteria.SetItemString(1, "select_username", state.SsUsername);
        ...
        private void RunProcess()
        {
            ...
            String coop_id = dw_criteria.GetItemString(1, "selectcoop_id");
           ...
           // lnv_helper.AddArgument(state.SsCoopName, ArgumentType.String);
            ...
            lnv_helper.AddArgument(select_username, ArgumentType.String);
