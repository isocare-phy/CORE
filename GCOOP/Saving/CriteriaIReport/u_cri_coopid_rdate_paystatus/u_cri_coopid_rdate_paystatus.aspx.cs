...
{
    public partial class u_cri_coopid_rdate_paystatus : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            //int paytype = dsMain.DATA[0].paytype;
            string paytype = dsMain.DATA[0].paytype;
            ...
            try
            {
                ...
                arg.Add("paytype", iReportArgumentType.String, paytype);
