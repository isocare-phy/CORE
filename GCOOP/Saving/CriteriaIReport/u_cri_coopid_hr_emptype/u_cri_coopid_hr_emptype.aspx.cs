...
{
    public partial class u_cri_coopid_hr_emptype : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string as_emptype = dsMain.DATA[0].emptype_code;
            ...
            try
            {
                ...
                arg.Add("as_emptype", iReportArgumentType.String, as_emptype);
