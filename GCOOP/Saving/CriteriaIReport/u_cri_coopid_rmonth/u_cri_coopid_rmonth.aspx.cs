...
namespace Saving.CriteriaIReport.u_cri_coopid_rmonth
{
    public partial class u_cri_coopid_rmonth : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            decimal an_smonth = dsMain.DATA[0].smonth;
            decimal an_emonth = dsMain.DATA[0].emonth;
            ...
            try
            {
                ...
                arg.Add("as_year", iReportArgumentType.Integer, an_year);
                arg.Add("as_smonth", iReportArgumentType.Integer, an_smonth);
                arg.Add("as_emonth", iReportArgumentType.Integer, an_emonth);
