...
namespace Saving.CriteriaIReport.u_cri_coopid_rmonth_rgroup_age
{
    public partial class u_cri_coopid_rmonth_rgroup_age : PageWebReport, WebReport
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            if (!IsPostBack)
            {
                ...
                dsMain.DATA[0].as_startmonth = "01";
            }            
        }
        ...
        public void RunReport()
        {
            ...
            Int32 age_mem = dsMain.DATA[0].age_mem;
            ...
            try
            {
                ...
                arg.Add("age_mem", iReportArgumentType.Integer, age_mem);
