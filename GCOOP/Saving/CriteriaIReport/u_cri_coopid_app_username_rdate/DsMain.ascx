<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.CriteriaIReport.u_cri_coopid_app_username_rdate.DsMain" %>
        ...
        <table class="iReportDataSourceFormView" >
            ...
            <tr>
               ...
               <tr>
                ...
                <td>
                    <div>
                        <asp:DropDownList ID="application" runat="server" ></asp:DropDownList>
                    </div>
                </td>
            </tr>
            <tr>
